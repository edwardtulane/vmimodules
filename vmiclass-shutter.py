...
2014-10-29 locations modified for acquisition PC
...
### Interpolation and remapping
 #
    ...
    def evalrect(self, density, displace=[0., 0.]):
...
###
    ...
    def invertBasex(self):
        self.bsx = vmp.Basex(self.rect, 0, 0, inv.M1, inv.M2)
...
### Plenty of plotting methods
 #
    ...
    def plotplain(self, img):
        self.__crfig, self.__crax = vmv.plot(img, cm=self.clrmap)
...
class HEimage(VMIimage):
    ...
    def __init__(self, file, xcntr=515, ycntr=480,
                 hotspots=[[325, 490], [45, 620]], radius=330):
        VMIimage.__init__(self, file, xcntr, ycntr, radius, hotspots)
        self.offset = 92.5
        self.disp = [-0.93814201, -0.60886962, -1.28898686]
