...
/* "vmimodules/vmimodules/hitdet/hitC.pyx":19
...
static PyObject *__pyx_pf_10vmimodules_10vmimodules_6hitdet_4hitC_gauss2dC(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_pars, int __pyx_v_dim, CYTHON_UNUSED PyObject *__pyx_v_norm, double __pyx_v_sig) {
  ...
  /* "vmimodules/vmimodules/hitdet/hitC.pyx":34
 *         int i, j, jj
 ...
 */
  ...
  /* "vmimodules/vmimodules/hitdet/hitC.pyx":39
 * 
 *         double x, y, xci, yci
 ...
 */
  ...
  /* "vmimodules/vmimodules/hitdet/hitC.pyx":40
 *         double x, y, xci, yci
 *         double[:] xc = pars.x_gau.values
 *         double[:] yc = pars.y_gau.values             # <<<<<<<<<<<<<<
 *         int peakno = xc.shape[0]
 ...
 */
  ...
  /* "vmimodules/vmimodules/hitdet/hitC.pyx":44
 * 
 *         double[:] xvec = np.zeros(dim)
 *         double[:] yvec = np.zeros(dim)             # <<<<<<<<<<<<<<
 *         double[::1, :] img = np.zeros([dim, dim], order='F')
 ...
 */
  ...
  /* "vmimodules/vmimodules/hitdet/hitC.pyx":48
 * 
 *     sig  = <double> 1 / (2 * sig * sig)
 *     qmax = <double> pi * sig             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "vmimodules/vmimodules/hitdet/hitC.pyx":51
 * 
 *     for i in range(peakno):
 *         xci = xc[i] + cntr             # <<<<<<<<<<<<<<
 *         yci = yc[i] + cntr
 ...
 */
    ...
    /* "vmimodules/vmimodules/hitdet/hitC.pyx":55
 * 
 *         ystart = <int> max(round(yci) - 40, 0)
 *         ystop  = <int> min(round(yci) + 40, dim - 1)             # <<<<<<<<<<<<<<
 *         yrng   = <int> max(ystop - ystart, 0)
 ...
 */
    ...
    /* "vmimodules/vmimodules/hitdet/hitC.pyx":59
 * 
 *         xstart = <int> max(round(xci) - 40, 0)
 *         xstop  = <int> min(round(xci) + 40, dim - 1)             # <<<<<<<<<<<<<<
 *         xrng   = <int> max(xstop - xstart, 0)
 ...
 */
    ...
    for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
      ...
      /* "vmimodules/vmimodules/hitdet/hitC.pyx":63
 * 
 *         for j in range(yrng):
 *             jj = <int> j + ystart             # <<<<<<<<<<<<<<
 *             y = <double> jj
 ...
 */
    ...
    for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
      ...
      /* "vmimodules/vmimodules/hitdet/hitC.pyx":71
 * 
 *         for j in range(xrng):
 *             jj = <int> j + xstart             # <<<<<<<<<<<<<<
 *             x = <double> jj
 ...
 */
    ...
    /* "vmimodules/vmimodules/hitdet/hitC.pyx":79
 * 
 *         dger(&yrng, &xrng, &qmax,
...
static PyObject *__pyx_pf_10vmimodules_10vmimodules_6hitdet_4hitC_2gaussquadC(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_pars, int __pyx_v_dim, double __pyx_v_sig) {
  ...
  /* "vmimodules/vmimodules/hitdet/hitC.pyx":99
 *         int i, j, jj
 *         int ystart, ystop, yrng, xstart, xstop, xrng
 *         int inc = 1             # <<<<<<<<<<<<<<
 *         double qmax
 ...
 */
  ...
  /* "vmimodules/vmimodules/hitdet/hitC.pyx":104
 * 
 *         double x, y, xci, yci
 *         double[:] xc = pars.x_gau.values             # <<<<<<<<<<<<<<
 *         double[:] yc = pars.y_gau.values
 ...
 */
  ...
  /* "vmimodules/vmimodules/hitdet/hitC.pyx":105
 *         double x, y, xci, yci
 *         double[:] xc = pars.x_gau.values
 *         double[:] yc = pars.y_gau.values             # <<<<<<<<<<<<<<
 *         int peakno = xc.shape[0]
 ...
 */
  ...
  /* "vmimodules/vmimodules/hitdet/hitC.pyx":109
 * 
 *         double[:] xvec = np.zeros(dim)
 *         double[:] yvec = np.zeros(dim)             # <<<<<<<<<<<<<<
 *         double[::1, :] img = np.zeros([dim, dim], order='F')
 ...
 */
  ...
  /* "vmimodules/vmimodules/hitdet/hitC.pyx":113
 * 
 *     sig  = <double> 1 / (2 * sig * sig)
 *     qmax = <double> pi * sig             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "vmimodules/vmimodules/hitdet/hitC.pyx":116
 * 
 *     for i in range(peakno):
 *         xci = <double> abs(xc[i])             # <<<<<<<<<<<<<<
 *         yci = <double> abs(yc[i])
 ...
 */
    ...
    /* "vmimodules/vmimodules/hitdet/hitC.pyx":120
 * 
 *         ystart = <int> max(round(yci) - 40, 0)
 *         ystop  = <int> min(round(yci) + 40, dim)             # <<<<<<<<<<<<<<
 *         yrng   = <int> max(ystop - ystart, 0)
 ...
 */
    ...
    /* "vmimodules/vmimodules/hitdet/hitC.pyx":124
 * 
 *         xstart = <int> max(round(xci) - 40, 0)
 *         xstop  = <int> min(round(xci) + 40, dim)             # <<<<<<<<<<<<<<
 *         xrng   = <int> max(xstop - xstart, 0)
 ...
 */
    ...
    for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
      ...
      /* "vmimodules/vmimodules/hitdet/hitC.pyx":128
 * 
 *         for j in range(yrng):
 *             jj = <int> j + ystart             # <<<<<<<<<<<<<<
 *             y = <double> jj
 ...
 */
    ...
    for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
      ...
      /* "vmimodules/vmimodules/hitdet/hitC.pyx":136
 * 
 *         for j in range(xrng):
 *             jj = <int> j + xstart             # <<<<<<<<<<<<<<
 *             x = <double> jj
 ...
 */
    ...
    /* "vmimodules/vmimodules/hitdet/hitC.pyx":144
 * 
 *         dger(&yrng, &xrng, &qmax,
 *              &yvec[0], &inc, &xvec[0], &inc,             # <<<<<<<<<<<<<<
 *              &img[ystart, xstart], &dim)
...
static PyObject *__pyx_pf_10vmimodules_10vmimodules_6hitdet_4hitC_4pixC(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_pars, int __pyx_v_dim) {
  ...
  /* "vmimodules/vmimodules/hitdet/hitC.pyx":157
 * 
 *     cdef:
 ...
 */
  ...
  /* "vmimodules/vmimodules/hitdet/hitC.pyx":158
 *     cdef:
 *         double[:,:] gss = np.zeros((dim, dim))
 *         int cntr = (dim - 1) / 2             # <<<<<<<<<<<<<<
 *         double[:] yc = pars.y_gau.values, xc = pars.x_gau.values
 ...
 */
  ...
  /* "vmimodules/vmimodules/hitdet/hitC.pyx":163
 *         unsigned int i
 * 
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "vmimodules/vmimodules/hitdet/hitC.pyx":164
 * 
 *     for i in range(length):
 *         y = <int> round(yc[i] + cntr)             # <<<<<<<<<<<<<<
 *         x = <int> round(xc[i] + cntr)
...
static PyObject *__pyx_pf_10vmimodules_10vmimodules_6hitdet_4hitC_6quadC(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_pars, int __pyx_v_dim) {
  ...
  /* "vmimodules/vmimodules/hitdet/hitC.pyx":175
 * 
 *     cdef:
 *         double[:,:] gss = np.zeros((dim, dim))             # <<<<<<<<<<<<<<
 *         double[:] yc = pars.y_gau.values, xc = pars.x_gau.values
 ...
 */
  ...
  /* "vmimodules/vmimodules/hitdet/hitC.pyx":176
 *     cdef:
 *         double[:,:] gss = np.zeros((dim, dim))
 *         double[:] yc = pars.y_gau.values, xc = pars.x_gau.values             # <<<<<<<<<<<<<<
 *         int length = yc.shape[0]
 ...
 */
  ...
  /* "vmimodules/vmimodules/hitdet/hitC.pyx":180
 *         unsigned int i
 * 
 *     for i in range(length):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "vmimodules/vmimodules/hitdet/hitC.pyx":181
 * 
 *     for i in range(length):
 *         y = <int> abs(round(yc[i]))             # <<<<<<<<<<<<<<
 *         x = <int> abs(round(xc[i]))
 ...
 */
  ...
  /* "vmimodules/vmimodules/hitdet/hitC.pyx":14
 ...
 *     """
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_10vmimodules_10vmimodules_6hitdet_4hitC_1gauss2dC, NULL, __pyx_n_s_vmimodules_vmimodules_hitdet_hit); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     Maps out normalised gaussian peaks on a single quadrant. Expects them to be centred.
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_10vmimodules_10vmimodules_6hitdet_4hitC_3gaussquadC, NULL, __pyx_n_s_vmimodules_vmimodules_hitdet_hit); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 87, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     cdef:
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_10vmimodules_10vmimodules_6hitdet_4hitC_5pixC, NULL, __pyx_n_s_vmimodules_vmimodules_hitdet_hit); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 154, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     cdef:
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_10vmimodules_10vmimodules_6hitdet_4hitC_7quadC, NULL, __pyx_n_s_vmimodules_vmimodules_hitdet_hit); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 172, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
